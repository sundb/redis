...
proc start_cluster {masters replicas options code {slot_allocator continuous_slot_allocation} {replica_allocator default_replica_allocation} {node_count {}}} {
    ...
    # The legacy cluster runner widened the failure detection window under
    # valgrind, where everything is slow enough that 3s of node timeout makes
    # nodes mark each other as failing. Keep that allowance.
